...
public class HomeStepDef {
	...
	LoginPage loginPage;
	HomePage homePage;
	 public HomeStepDef(TextContext context) {
	 testContext = context;
	...
	public void user_confirms_the_links_are_corresponding_to_their_respective_pages() throws InterruptedException {
		homePage.getfindAPuppyPage();
		 String findPuppyUrl = testContext.webDriverManager.driver.getCurrentUrl();
		...
		String listPuppyUrl = testContext.webDriverManager.driver.getCurrentUrl();
		...
		String moreInfoUrl = testContext.webDriverManager.driver.getCurrentUrl();
		...
		homePage.getSupport();
		String supportUrl = testContext.webDriverManager.driver.getCurrentUrl();
	...
	public void user_Clicks_a_link_in_popular_dog_breeds() throws InterruptedException  {
		//pageObjectManager = new PageObjectManager(driver);
		//homePage = pageObjectManager.getHomePage();
		JavascriptExecutor js = ((JavascriptExecutor) testContext.webDriverManager.driver);
	...
	public void user_verifies_the_details_of_the_breed() {
		String BreedDetail = testContext.webDriverManager.driver.findElement(By.xpath("//h2[@class='margin-bottom-0']")).getText();
	...
	public void clicks_on_that_breed_puppies_for_sale() throws InterruptedException {
		...
		Thread.sleep(CONSTANTS.STEP_DELAY);
		testContext.webDriverManager.driver.findElement(By.xpath("	//div[@class='featured-info']//div[@class='btn puppies-btn']")).click();
		
	}

	@Then("^verifies the search results displayed$")
	public void verifies_the_search_results_displayed()  {
		String searchRes = testContext.webDriverManager.driver.findElement(By.xpath("//table[@width='100%']//tbody//tr//td//h1")).getText();
